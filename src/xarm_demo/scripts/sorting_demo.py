...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
		...
		#正方体123
		#正方体1
        if demo.pick(0.47,  -0.055, 0.21) == True:
            demo.place(0.04, 0.25, 0.224)
		#正方体2
        if demo.pick(0.245,  -0.09, 0.21) == True:
            demo.place(0.04, 0.25, 0.26)
		#正方体3
        if demo.pick(0.325,  0.1, 0.21) == True:
            demo.place(0.04, 0.25, 0.293)
        

		#长方体456
		#长方体4
        if demo.pick(0.42,  -0.1, 0.205) == True:
            demo.place(0.13, 0.25, 0.223)
		#长方体5
        if demo.pick(0.385,  0.1, 0.205) == True:
            demo.place(0.13, 0.25, 0.247)
		#长方体6
        if demo.pick(0.26,  0.055, 0.205) == True:
            demo.place(0.13, 0.25, 0.266)
		
        
		#圆柱789
		#圆柱7
        if demo.pick_cy(0.33,  0, 0.21) == True:
            demo.place(0.22, 0.25, 0.232)
		#圆柱8
        if demo.pick_cy(0.45,  0.06, 0.21) == True:
            demo.place(0.22, 0.25, 0.277)
		#圆柱9
        if demo.pick_cy(0.32,  -0.135, 0.21) == True:
